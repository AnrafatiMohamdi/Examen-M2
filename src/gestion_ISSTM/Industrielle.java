...
public class Industrielle extends javax.swing.JFrame {
    ResultSet rs;
    db_connection db;
    ...
    public void table() {
        ...
        rs = db.querySelect(t, "Labo_ind");
        tbl_Ind.setModel(new ResultSetTableModel(rs));
    }
    ...
    private void initComponents() {
        ...
        tbl_Ind = new javax.swing.JTable();
        ...
        tbl_Ind.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_Ind.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                tbl_IndAncestorAdded(evt);
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
            }
        });
        tbl_Ind.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_IndMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tbl_Ind);
        ...
        jLabel15.setText("         Labo du Genie Industrielle");
    ...
    private void tbl_IndAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_tbl_IndAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_tbl_IndAncestorAdded

    private void tbl_IndMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_IndMouseClicked
        txtid.setText(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 1)));
        nomO.setSelectedItem(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 2)));
        txtdes.setText(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 3)));
        txtran.setText(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 4)));
        txtfou.setText(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 5)));
        txtrem.setText(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 6)));
        txtpri.setText(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 7)));
        txtsto.setText(String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 8)));
    }//GEN-LAST:event_tbl_IndMouseClicked
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtid.getText().equals("") || nomO.getSelectedItem().equals("Marque") || txtdes.getText().equals("")
            ...
            System.out.println(db.queryInsert("labo_ind", colon, inf));
            table();
            actualiser();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (txtid.getText().equals("") ||nomO.getSelectedItem().equals("Marque") || txtdes.getText().equals("")
            ...
            String[] inf = {txtid.getText(),nomO.getSelectedItem().toString(), txtdes.getText(),txtran.getText(),txtfou.getText()
                ,txtrem.getText(),txtpri.getText(),txtsto.getText()};
            String id = String.valueOf(tbl_Ind.getValueAt(tbl_Ind.getSelectedRow(), 0));
            System.out.println(db.queryUpdate("labo_ind", colon, inf, "id='" + id + "'"));
            table();
            actualiser();
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("id")) {
                rs = db.querySelectAll("labo_ind", "id LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("matricule")) {
                rs = db.querySelectAll("labo_ind", "Matricule LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("PC")) {
                rs = db.querySelectAll("labo_ind", "PC LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("processeur")) {
                rs = db.querySelectAll("labo_ind", "Processeur LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("ram")) {
                rs = db.querySelectAll("labo_ind", "Ram LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("disqueDur")) {
                rs = db.querySelectAll("labo_ind", "DisqueDur LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("graphique")) {
                rs = db.querySelectAll("labo_ind", "Graphique LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("generation")) {
                rs = db.querySelectAll("labo_ind", "Generation LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("nombre")) {
                rs = db.querySelectAll("labo_ind", "Nombre LIKE '%" + txtrech.getText() + "%' ");
                tbl_Ind.setModel(new ResultSetTableModel(rs));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Industrielle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Industrielle().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbl_Ind;
