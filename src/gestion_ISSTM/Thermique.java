...
public class Thermique extends javax.swing.JFrame {
    ResultSet rs;
    db_connection db;
    ...
    public void table() {
        ...
        rs = db.querySelect(t, "Labo_t");
        tbl_th.setModel(new ResultSetTableModel(rs));
    }
    ...
    private void initComponents() {
        ...
        tbl_th.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tbl_th.addAncestorListener(new javax.swing.event.AncestorListener() {
            public void ancestorMoved(javax.swing.event.AncestorEvent evt) {
            }
            public void ancestorAdded(javax.swing.event.AncestorEvent evt) {
                tbl_thAncestorAdded(evt);
            }
            public void ancestorRemoved(javax.swing.event.AncestorEvent evt) {
            }
        });
        tbl_th.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_thMouseClicked(evt);
            }
        });
        jScrollPane3.setViewportView(tbl_th);
        ...
        jLabel15.setText("         Labo du Genie Thermique ");
    ...
    private void tbl_thAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_tbl_thAncestorAdded
        // TODO add your handling code here:
    }//GEN-LAST:event_tbl_thAncestorAdded

    private void tbl_thMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_thMouseClicked
        txtid.setText(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 1)));
        nomO.setSelectedItem(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 2)));
        txtdes.setText(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 3)));
        txtran.setText(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 4)));
        txtfou.setText(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 5)));
        txtrem.setText(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 6)));
        txtpri.setText(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 7)));
        txtsto.setText(String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 8)));
    }//GEN-LAST:event_tbl_thMouseClicked
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (txtid.getText().equals("") || nomO.getSelectedItem().equals("Marque") || txtdes.getText().equals("")
            ...
            System.out.println(db.queryInsert("labo_t", colon, inf));
            table();
            actualiser();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        if (txtid.getText().equals("") ||nomO.getSelectedItem().equals("Marque") || txtdes.getText().equals("")
            ...
            String[] inf = {txtid.getText(),nomO.getSelectedItem().toString(), txtdes.getText(),txtran.getText(),txtfou.getText()
                ,txtrem.getText(),txtpri.getText(),txtsto.getText()};
            String id = String.valueOf(tbl_th.getValueAt(tbl_th.getSelectedRow(), 0));
            System.out.println(db.queryUpdate("labo_t", colon, inf, "id='" + id + "'"));
            table();
            actualiser();
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("id")) {
                rs = db.querySelectAll("labo_t", "id LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("matricule")) {
                rs = db.querySelectAll("labo_t", "Matricule LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("PC")) {
                rs = db.querySelectAll("labo_t", "PC LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("processeur")) {
                rs = db.querySelectAll("labo_t", "Processeur LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("ram")) {
                rs = db.querySelectAll("labo_t", "Ram LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("disqueDur")) {
                rs = db.querySelectAll("labo_t", "DisqueDur LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("graphique")) {
                rs = db.querySelectAll("labo_t", "Graphique LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("generation")) {
                rs = db.querySelectAll("labo_t", "Generation LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("nombre")) {
                rs = db.querySelectAll("labo_t", "Nombre LIKE '%" + txtrech.getText() + "%' ");
                tbl_th.setModel(new ResultSetTableModel(rs));
   ...
   private static final Logger LOG = Logger.getLogger(Civile.class.getName());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Thermique.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbl_th;
